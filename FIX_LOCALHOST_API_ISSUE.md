...
- If hostname is NOT localhost → use production URL (`https://adhar-pan-kyc.onrender.com/api`)
...
4. Add/Update the following variable:
   ...
   Value: https://adhar-pan-kyc.onrender.com/api
...
3. You should see:
   ```
   🔗 API Base URL: https://adhar-pan-kyc.onrender.com/api
   🔗 REACT_APP_API_URL: https://adhar-pan-kyc.onrender.com/api
   ```
4. Check Network tab to verify API calls are going to `https://adhar-pan-kyc.onrender.com/api`
...
- When deployed to `https://adhar-pan-kyc.onrender.com`
- API calls will go to: `https://adhar-pan-kyc.onrender.com/api` ✅
...
- [ ] Set `REACT_APP_API_URL=https://adhar-pan-kyc.onrender.com/api` in AWS Amplify
